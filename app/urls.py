...
urlpatterns = [
    ...
    path('bourbon', views.bourbon),	 
    path('bourbon2', views.bourbon2),	 
    path('cordials', views.cordials),	 
    path('gin', views.gin),	 
    path('rum', views.rum),	 
    path('tequila', views.tequila),	 
    path('cognac', views.cognac),	 
    path('scotch', views.scotch),	 
    path('wells', views.wells),	 
